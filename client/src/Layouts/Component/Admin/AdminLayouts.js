...
import PhoneAdminSiderbar from './AdminSidebar/PhoneSiderbar';
import withComponent from 'Hocs/withComponent';
import AdminSidebar from './AdminSidebar/Siderbar';
import path from 'Router/path';

const { IoHomeSharp, TiThMenu } = Icons;

const AdminLayouts = ({ navigate, dispatch }) => {
    ...
    return (
        <div className="flex relative w-full min-h-screen">
            <div className="laptop:w-[20%] h-full">
                <PhoneAdminSiderbar showNavBarMenu={showNavBarMenu} ref={navBarRef} />
...
export default withComponent(AdminLayouts);
